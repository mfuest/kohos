            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed max-w-xl">
                  In Munich, every cup tells a story. Every café is a meeting place. 
                  Every conversation over coffee creates something extraordinary.
                </p>
              </div>
            ...
            <div className="relative">
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-card to-card/50 backdrop-blur-sm border border-border shadow-elegant">
                ...
                <div className="absolute bottom-6 left-6 text-white">
                  <h3 className="text-2xl font-semibold mb-2">Munich's Heart</h3>
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Munich's specialty coffee culture isn't just about the perfect extraction or artisan roasting. 
                  It's about the conversations that happen between strangers, the ideas born over shared tables, 
                  and the community that forms around something as simple as a cup of coffee.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <p className="text-muted-foreground">Authentic connections over exceptional coffee</p>
                </div>
                <div className="flex items-start space-x-4">
                  <div className="w-2 h-2 rounded-full bg-primary mt-3 flex-shrink-0"></div>
                  <p className="text-muted-foreground">Creators sharing genuine Munich experiences</p>
                </div>
                <div className="flex items-start space-x-4">
                  <div className="w-2 h-2 rounded-full bg-primary mt-3 flex-shrink-0"></div>
                  <p className="text-muted-foreground">Community-driven storytelling that matters</p>
                </div>
              </div>
            </div>
              ...
              <div className="relative bg-card/30 backdrop-blur-sm rounded-3xl border border-border p-8">
                <div className="text-center space-y-6">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    We believe the best brand stories aren't scripted. They're discovered in the authentic moments 
                    between people, places, and shared experiences.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-primary/10 via-brand-light/20 to-primary/5 p-12 md:p-16 border border-primary/20">
            ...
            <div className="relative z-10 text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                Are you a creator who understands that the best content comes from authentic experiences? 
                Join Kohos and become part of Munich's coffee storytelling community.
              </p>
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-10">
                <div className="bg-background/60 backdrop-blur-sm rounded-2xl p-6 border border-border">
                  ...
                  <h4 className="font-semibold text-coffee-dark mb-2">Free Coffee</h4>
                  <p className="text-sm text-muted-foreground">Premium beans, artisan preparation</p>
                </div>
                <div className="bg-background/60 backdrop-blur-sm rounded-2xl p-6 border border-border">
                  <Camera className="w-8 h-8 text-primary mx-auto mb-3" />
                  <h4 className="font-semibold text-coffee-dark mb-2">Creative Freedom</h4>
                  <p className="text-sm text-muted-foreground">Authentic brand partnerships</p>
                </div>
                <div className="bg-background/60 backdrop-blur-sm rounded-2xl p-6 border border-border">
                  <Heart className="w-8 h-8 text-primary mx-auto mb-3" />
                  <h4 className="font-semibold text-coffee-dark mb-2">Community</h4>
                  <p className="text-sm text-muted-foreground">Be part of something bigger</p>
                </div>
              </div>
