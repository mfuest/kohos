...
import { MapPin, Users, TrendingUp, Instagram, Calendar } from "lucide-react";
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <Card className="text-center">
                <CardContent className="pt-6">
                  <div className="text-2xl font-bold text-coffee-dark">{creator.stats.totalCampaigns}</div>
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  <div className="text-2xl font-bold text-green-600">{creator.stats.activeCampaigns}</div>
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  <div className="text-2xl font-bold text-blue-600">{creator.stats.completedCampaigns}</div>
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  <div className="text-2xl font-bold text-yellow-600">{creator.stats.averageRating}</div>
                  ...
                  {activeCampaigns.map((campaign, index) => (
                    <div key={index} className="flex items-center justify-between p-4 border rounded-lg">
                      ...
                      <div className="flex items-center space-x-4">
                        <Badge variant={
                          campaign.status === "In Progress" ? "default" :
                          campaign.status === "Review" ? "secondary" : "outline"
                        }>
                          {campaign.status}
                        </Badge>
